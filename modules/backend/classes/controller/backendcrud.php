 ...
 */
abstract class Controller_BackendCRUD extends Controller_Backend
{
    /**
    ...
    protected function _model($action, $model, array $params = NULL)
    {
        ...
        if ($action != 'create')
        {
            ...
            if ($model->id === NULL)
            {
                ...
                throw new Controller_BackendCRUD_Exception($this->_format($msg, $model));
            }
        }
    ...
    protected function _form_delete(Model $model, array $params = NULL)
    {
        ...
        $form = new Form_Backend_Confirm($msg);
    ...
    protected function _validate($action, Model $model, Form $form, array $params = NULL)
    {
        ...
        if ($form_result === FALSE) return FALSE;
    ...
    protected function _action($action, array $params = array())
    {
        ...
        catch (Controller_BackendCRUD_Exception $e)
        {
