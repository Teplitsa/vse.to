...
class View_Helper_Admin
{
     ...
     * @return string
     */
    public static function image_control($url, $title, $image, $alt = NULL, $module = 'backend')
    {
        if ($alt === NULL)
        {
            $alt = $title;
     ...
     * @return string
     */
    public static function image($image, $alt = NULL, $module = 'backend')
    {
        return HTML::image(Modules::uri($module) . '/public/css/backend/' . $image, array('alt' => $alt));
    }
