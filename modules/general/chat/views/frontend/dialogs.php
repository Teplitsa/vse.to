...
<?php
$create_url = URL::to('frontend/messages', array('action'=>'create'), TRUE);
$messages_url = URL::to('frontend/messages', array('action'=>'index','dialog_id' => '${id}'),TRUE);
$delete_url = URL::to('frontend/dialogs', array('action'=>'delete', 'id' => '{{id}}'), TRUE);
$multi_action_uri = URL::uri_to('frontend/dialogs', array('action'=>'multi'), TRUE);
?>
