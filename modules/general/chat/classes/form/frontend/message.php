...
class Form_Frontend_Message extends Form_Frontend {
    ...
    {        
        ...
        $button->url   = URL::to('frontend/acl', array('action' => 'user_select','group_id' => Model_Group::EDITOR_GROUP_ID), TRUE);
    ...
    public function render_js()
    {
        ...
        Layout::instance()->add_script(Modules::uri('chat') . '/public/js/frontend/mesuser.js');        
