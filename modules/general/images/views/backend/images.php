...
$update_url = URL::to('backend/images', array('action'=>'update', 'id' => '${id}', 'config' => $config), TRUE);
$delete_url = URL::to('backend/images', array('action'=>'delete', 'id' => '${id}', 'config' => $config), TRUE);

$up_url   = URL::to('backend/images', array('action'=>'up', 'id' => '${id}'), TRUE);
$down_url = URL::to('backend/images', array('action'=>'down', 'id' => '${id}'), TRUE);
if ( ! $desc)
{
