<?php defined('SYSPATH') or die('No direct script access.');
    ...
    else if ($provider == Model_Product::HANGOTS)
    {
        ...
        $hangouts_test_url = base64_decode($product->hangouts_test_url);
    }
    ...
    switch ($stage) {
        ...
        case Model_Product::START_STAGE:
            ...
            if(!empty($hangouts_test_url))
                echo '<a href="',$hangouts_test_url,'" class="request-link button" target="_blank">Присоединиться к тесту</a>';
